/*
  ...
  /usr/bin/gengetopt --input=/home/flo/Inpartik/Development/Kaleidoscope/Kaleidoscope-Papageno/build/modules/Kaleidoscope-Papageno/papageno/glockenspiel/src/CommandLine/GLS_CommandLineGengetopt.txt --file-name=GLS_CommandLineGengetopt --header-extension=hpp --c-extension=cpp --include-getopt 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --join_duplicate_entities Join duplicate actions and inputs  (default=on)",
  "      --join_duplicate_actions  Join duplicate actions  (default=on)",
  "      --join_duplicate_inputs   Join duplicate inputs  (default=on)",
  "      --join_note_sequences     Join note sequences  (default=on)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->join_duplicate_entities_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->join_duplicate_entities_flag = 1;
  args_info->join_duplicate_actions_flag = 1;
  args_info->join_duplicate_inputs_flag = 1;
  args_info->join_note_sequences_flag = 1;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->join_duplicate_entities_help = gengetopt_args_info_help[8] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->join_duplicate_entities_given)
    write_into_file(outfile, "join_duplicate_entities", 0, 0 );
  if (args_info->join_duplicate_actions_given)
    write_into_file(outfile, "join_duplicate_actions", 0, 0 );
  if (args_info->join_duplicate_inputs_given)
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "debug",	0, NULL, 'd' },
        { "join_duplicate_entities",	0, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* Join duplicate actions and inputs.  */
          if (strcmp (long_options[option_index].name, "join_duplicate_entities") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->join_duplicate_entities_flag), 0, &(args_info->join_duplicate_entities_given),
                &(local_args_info.join_duplicate_entities_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "join_duplicate_entities", '-',
                additional_error))
              goto failure;
          
          }
          /* Join duplicate actions.  */
          else if (strcmp (long_options[option_index].name, "join_duplicate_actions") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->join_duplicate_actions_flag), 0, &(args_info->join_duplicate_actions_given),
                &(local_args_info.join_duplicate_actions_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "join_duplicate_actions", '-',
                additional_error))
              goto failure;
          
          }
          /* Join duplicate inputs.  */
          else if (strcmp (long_options[option_index].name, "join_duplicate_inputs") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->join_duplicate_inputs_flag), 0, &(args_info->join_duplicate_inputs_given),
                &(local_args_info.join_duplicate_inputs_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "join_duplicate_inputs", '-',
                additional_error))
              goto failure;
          
          }
          /* Join note sequences.  */
          else if (strcmp (long_options[option_index].name, "join_note_sequences") == 0)
          {
