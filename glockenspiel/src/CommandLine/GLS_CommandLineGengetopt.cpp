/*
  ...
  /usr/bin/gengetopt --input=/home/flo/Inpartik/Development/Kaleidoscope/Kaleidoscope-Papageno/build_python/modules/Kaleidoscope-Papageno/papageno/glockenspiel/src/CommandLine/GLS_CommandLineGengetopt.txt --file-name=GLS_CommandLineGengetopt --header-extension=hpp --c-extension=cpp --include-getopt 
...
#include "GLS_CommandLineGengetopt.hpp"

const char *gengetopt_args_info_purpose = "A compiler for Papageno's description language.";

const char *gengetopt_args_info_usage = "Usage: glockenspiel [OPTIONS]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Generates C code of a statically allocated pattern matching tree from a\ndescription in Papageno's own language.";

const char *gengetopt_args_info_help[] = {
  "  -h, --help                    Print help and exit",
  "  -V, --version                 Print version and exit",
  "  -i, --source_filename=STRING  Source filename",
  "  -o, --output_filename=STRING  Output filename",
  "  -p, --preamble_filename=STRING\n                                Preamble filename",
  "  -n, --project_name=STRING     The name of the project to generate Papageno\n                                  code for",
  "  -I, --include_directory=STRING\n                                Include directory",
  "  -d, --debug                   Generate debug output during the compile\n                                  (default=off)",
  "      --no_join_duplicate_actions\n                                Join duplicate actions  (default=off)",
  "      --no_join_duplicate_inputs\n                                Join duplicate inputs  (default=off)",
  "      --no_join_note_sequences  Join note sequences  (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->source_filename_given = 0 ;
  args_info->output_filename_given = 0 ;
  args_info->preamble_filename_given = 0 ;
  args_info->project_name_given = 0 ;
  args_info->include_directory_given = 0 ;
  args_info->debug_given = 0 ;
  args_info->no_join_duplicate_actions_given = 0 ;
  args_info->no_join_duplicate_inputs_given = 0 ;
  args_info->no_join_note_sequences_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->source_filename_arg = NULL;
  args_info->source_filename_orig = NULL;
  args_info->output_filename_arg = NULL;
  args_info->output_filename_orig = NULL;
  args_info->preamble_filename_arg = NULL;
  args_info->preamble_filename_orig = NULL;
  args_info->project_name_arg = NULL;
  args_info->project_name_orig = NULL;
  args_info->include_directory_arg = NULL;
  args_info->include_directory_orig = NULL;
  args_info->debug_flag = 0;
  args_info->no_join_duplicate_actions_flag = 0;
  args_info->no_join_duplicate_inputs_flag = 0;
  args_info->no_join_note_sequences_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->source_filename_help = gengetopt_args_info_help[2] ;
  args_info->source_filename_min = 0;
  args_info->source_filename_max = 0;
  args_info->output_filename_help = gengetopt_args_info_help[3] ;
  args_info->preamble_filename_help = gengetopt_args_info_help[4] ;
  args_info->project_name_help = gengetopt_args_info_help[5] ;
  args_info->include_directory_help = gengetopt_args_info_help[6] ;
  args_info->include_directory_min = 0;
  args_info->include_directory_max = 0;
  args_info->debug_help = gengetopt_args_info_help[7] ;
  args_info->no_join_duplicate_actions_help = gengetopt_args_info_help[8] ;
  args_info->no_join_duplicate_inputs_help = gengetopt_args_info_help[9] ;
  args_info->no_join_note_sequences_help = gengetopt_args_info_help[10] ;
  args_info->allow_auto_type_definition_help = gengetopt_args_info_help[11] ;
  args_info->allow_auto_input_type_definition_help = gengetopt_args_info_help[12] ;
  args_info->allow_auto_action_type_definition_help = gengetopt_args_info_help[13] ;
  args_info->macros_prefix_help = gengetopt_args_info_help[14] ;
  args_info->symbols_prefix_help = gengetopt_args_info_help[15] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->source_filename_given, &(args_info->source_filename_arg), &(args_info->source_filename_orig));
  free_string_field (&(args_info->output_filename_arg));
  free_string_field (&(args_info->output_filename_orig));
  free_string_field (&(args_info->preamble_filename_arg));
  free_string_field (&(args_info->preamble_filename_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->source_filename_given, "source_filename", args_info->source_filename_orig, 0);
  if (args_info->output_filename_given)
    write_into_file(outfile, "output_filename", args_info->output_filename_orig, 0);
  if (args_info->preamble_filename_given)
    write_into_file(outfile, "preamble_filename", args_info->preamble_filename_orig, 0);
  if (args_info->project_name_given)
    write_into_file(outfile, "project_name", args_info->project_name_orig, 0);
  write_multiple_into_file(outfile, args_info->include_directory_given, "include_directory", args_info->include_directory_orig, 0);
  if (args_info->debug_given)
    write_into_file(outfile, "debug", 0, 0 );
  if (args_info->no_join_duplicate_actions_given)
    write_into_file(outfile, "no_join_duplicate_actions", 0, 0 );
  if (args_info->no_join_duplicate_inputs_given)
    write_into_file(outfile, "no_join_duplicate_inputs", 0, 0 );
  if (args_info->no_join_note_sequences_given)
    write_into_file(outfile, "no_join_note_sequences", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->source_filename_given)
    {
      fprintf (stderr, "%s: '--source_filename' ('-i') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->source_filename_given, args_info->source_filename_min, args_info->source_filename_max, "'--source_filename' ('-i')"))
     error_occurred = 1;
  
  if (! args_info->output_filename_given)
    {
      fprintf (stderr, "%s: '--output_filename' ('-o') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->include_directory_given, args_info->include_directory_min, args_info->include_directory_max, "'--include_directory' ('-I')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * source_filename_list = NULL;
  struct generic_list * include_directory_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        { "help",	0, NULL, 'h' },
        { "version",	0, NULL, 'V' },
        { "source_filename",	1, NULL, 'i' },
        { "output_filename",	1, NULL, 'o' },
        { "preamble_filename",	1, NULL, 'p' },
        { "project_name",	1, NULL, 'n' },
        { "include_directory",	1, NULL, 'I' },
        { "debug",	0, NULL, 'd' },
        { "no_join_duplicate_actions",	0, NULL, 0 },
        { "no_join_duplicate_inputs",	0, NULL, 0 },
        { "no_join_note_sequences",	0, NULL, 0 },
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:p:n:I:d", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* Source filename.  */
        
          if (update_multiple_arg_temp(&source_filename_list, 
              &(local_args_info.source_filename_given), optarg, 0, 0, ARG_STRING,
              "source_filename", 'i',
              additional_error))
            goto failure;
        ...
        case 'o':	/* Output filename.  */
          ...
          if (update_arg( (void *)&(args_info->output_filename_arg), 
              ...
              &(local_args_info.output_filename_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'p':	/* Preamble filename.  */
        
        
          if (update_arg( (void *)&(args_info->preamble_filename_arg), 
               &(args_info->preamble_filename_orig), &(args_info->preamble_filename_given),
              &(local_args_info.preamble_filename_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "preamble_filename", 'p',
              additional_error))
            goto failure;
          ...
          break;
        case 'n':	/* The name of the project to generate Papageno code for.  */
        
        
          if (update_arg( (void *)&(args_info->project_name_arg), 
               &(args_info->project_name_orig), &(args_info->project_name_given),
              &(local_args_info.project_name_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "project_name", 'n',
              additional_error))
            goto failure;
        ...
        case 'I':	/* Include directory.  */
          ...
          if (update_multiple_arg_temp(&include_directory_list, 
              &(local_args_info.include_directory_given), optarg, 0, 0, ARG_STRING,
              "include_directory", 'I',
              additional_error))
            goto failure;
        
          break;
        case 'd':	/* Generate debug output during the compile.  */
        ...
        case 0:	/* Long option with no short option */
          /* Join duplicate actions.  */
          if (strcmp (long_options[option_index].name, "no_join_duplicate_actions") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->no_join_duplicate_actions_flag), 0, &(args_info->no_join_duplicate_actions_given),
                &(local_args_info.no_join_duplicate_actions_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "no_join_duplicate_actions", '-',
                additional_error))
              goto failure;
          
          }
          /* Join duplicate inputs.  */
          else if (strcmp (long_options[option_index].name, "no_join_duplicate_inputs") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->no_join_duplicate_inputs_flag), 0, &(args_info->no_join_duplicate_inputs_given),
                &(local_args_info.no_join_duplicate_inputs_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "no_join_duplicate_inputs", '-',
                additional_error))
              goto failure;
          
          }
          /* Join note sequences.  */
          else if (strcmp (long_options[option_index].name, "no_join_note_sequences") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->no_join_note_sequences_flag), 0, &(args_info->no_join_note_sequences_given),
                &(local_args_info.no_join_note_sequences_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "no_join_note_sequences", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->source_filename_arg),
    &(args_info->source_filename_orig), args_info->source_filename_given,
    local_args_info.source_filename_given, 0,
    ARG_STRING, source_filename_list);
  update_multiple_arg((void *)&(args_info->include_directory_arg),
    &(args_info->include_directory_orig), args_info->include_directory_given,
    local_args_info.include_directory_given, 0,
    ARG_STRING, include_directory_list);

  args_info->source_filename_given += local_args_info.source_filename_given;
  local_args_info.source_filename_given = 0;
  args_info->include_directory_given += local_args_info.include_directory_given;
  local_args_info.include_directory_given = 0;
...
failure:
  free_list (source_filename_list, 1 );
  free_list (include_directory_list, 1 );
