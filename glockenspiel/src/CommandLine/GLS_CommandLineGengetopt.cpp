/*
  ...
  /usr/bin/gengetopt --input=/scratch/tmp/fleissne/Projects/Kaleidoscope/Kaleidoscope-Papageno/build/modules/Kaleidoscope-Papageno/papageno/glockenspiel/src/CommandLine/GLS_CommandLineGengetopt.txt --file-name=GLS_CommandLineGengetopt --header-extension=hpp --c-extension=cpp --include-getopt 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --join_duplicate_entities Join duplicate actions and inputs\n                                  (default=off)",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->join_duplicate_entities_flag = 0;
